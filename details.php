...
<head>
	...
	<link rel="stylesheet" type="text/css" href="idetails.css">
</head>
...
">Sign Out of Your Account</a>
		...
		<div class ="jumbotron" style="background-color:#ffff99;         margin-bottom: 1rem;border-bottom: 3px solid black !important;padding: 5rem 2rem;">
	...
	<form action="insert.php" method="post" href="idetails.css">
